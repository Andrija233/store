            ...
            {userInfo ? (
              <form onSubmit={submitHandler}>
                ...
                <button
                  ...
                  className="bg-pink-600 text-white py-2 px-4 rounded-lg cursor-pointer hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-opacity-50"
                >
                  Submit
                </button>
              </form>
